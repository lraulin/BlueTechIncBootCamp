<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageTwo.aspx.cs" Inherits="School1.WebForm2"%>
...
<body>
  <form id="form1" runat="server">
    ...
    <div>
      <h1>Exercise 4: Display data from loops</h1>
      <div>
      ...
      <div>
        <asp:Label ID="lbl4ciii" runat="server"></asp:Label>
      </div>
    </div>
    <div>
      <h1>Exercise 5: Return Data from a Function</h1>
      <table>
        <tr>
          <td>
